...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, police, taxi, mechanic, unemployed, players = 0, 0, 0, 0, 0, 0, 0
	...
	SendNUIMessage({
		...
		jobs = {ems = ems, police = police, taxi = taxi, mechanic = mechanic, unemployed = unemployed, player_count = players}
	})
end
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, 166) and IsInputDisabled(0) then
